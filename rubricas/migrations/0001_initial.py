    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competencias', models.ManyToManyField(related_name='_curso_competencias_+', to='rubricas.Competencia')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contenedora', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.patologia')),
            ],
        ),
        migrations.CreateModel(
            name='Procedimiento',
            fields=[
                ...
                ('capitulo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.capituloprocedimientos')),
                ('contenedora', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.procedimiento')),
            ],
        ),
        migrations.CreateModel(
            name='Programa',
            fields=[
                ...
                ('competencias', models.ManyToManyField(related_name='_programa_competencias_+', to='rubricas.Competencia')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.curso')),
            ],
        ),
        migrations.CreateModel(
            name='Rubrica',
            fields=[
                ...
                ('secciones', models.ManyToManyField(blank=True, related_name='_rubrica_secciones_+', to='rubricas.Seccion')),
            ],
        ),
        migrations.AddField(
            model_name='procedimiento',
            name='seccion',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.seccionprocedimientos'),
        ),
        migrations.CreateModel(
            name='NivelCriterio',
            fields=[
        ...
        migrations.AddField(
            ...
            name='grupo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='rubricas.grupocompetencia'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('itemcalificacion_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rubricas.itemcalificacion')),
