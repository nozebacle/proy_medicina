...
from rubricas.models.rubricas import ItemCalificacionCurso
...
class Test_ItemCalificacionCurso(TestCase):
    ...
    def setUp(self):
        ...
        ic1 = ItemCalificacionCurso.objects.create(nombre="item1", peso=25, rubrica=r1, curso=curso)
        self.ic1_id = ic1.id
    ...
    def test_str(self):
        "El método str muestra el nombre del ítem de calificación, el peso, el nombre de la rúbrica y el nombre del curso"
        ic1 = ItemCalificacionCurso.objects.get(id=self.ic1_id)
        self.assertTrue("item1" in str(ic1))
        self.assertTrue("25" in str(ic1))
        self.assertTrue("LaRubrica_1" in str(ic1))
        self.assertTrue("nombre_curso" in str(ic1))
